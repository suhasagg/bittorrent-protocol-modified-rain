...
// Used to store downloaded blocks in pool which are then serialised to disk
type Pool struct {
	pool sync.Pool
}
...
//Buffer is allocated in units of file pieces size
//Peers use buffer to store downloaded pieces/file blocks
