...
// Semaphore used to control access to a common resource by multiple goroutines.
// Custom semaphore design -
// Provision to cap counting semaphore length based on parameters
// Based on input parameters, one dimensional, two dimensional semaphores can be created (different blocking conditions based on two dimensions)
