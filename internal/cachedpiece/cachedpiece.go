...
// CachedPiece is a wrapper around a piece.Piece object that is capable of reading the data from a piececache.Cache.
// File pieces which are stored in cache for faster upload
