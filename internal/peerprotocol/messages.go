...
// InterestedMessage is sent to peer that we wa nt to request pieces if you unchoke us.
...
// HaveAllMessage can be sent to peer to indicate that we are a seed for this torrent.(It is a torrent seed, not a leecher because it has all the file pieces and torrent files have been downloaded)
