...
//Multiple tracker urls are there (corresponding to each peer)
...
// If announce fails, the next announce will be made to the next Tracker in the tier.
...
//Rotates tracker urls - cyclically
