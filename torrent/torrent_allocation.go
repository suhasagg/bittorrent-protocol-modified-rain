...
func (t *torrent) handleAllocationDone(al *allocator.Allocator) {
	...
	//Pieces specific to a torrent are supplied to piece picker
	//For a specific torrent, different pieces will have different distribution for different nodes,
	//Prioritization will be for faster pieces for each peer
